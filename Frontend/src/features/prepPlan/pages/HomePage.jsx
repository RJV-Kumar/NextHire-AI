...
const HomePage = () => {
    ...
    return (
        <div className='home-page'>
            ...
            {/* Main Card */}
            <div className='prepplan-card'>
                <div className='prepplan-card__body'>
                ...
                {/* Card Footer */}
                <div className='prepplan-card__footer'>
            ...
            {reports?.length > 0 && (
                <section className='recent-reports'>
                    ...
                    <ul className='reports-list'>
                        {reports.map(report => (
                            <li key={report._id} className='report-item' onClick={() => navigate(`/reports/${report._id}`)}>
